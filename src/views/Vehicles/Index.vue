<template>
    <div class="flex flex-col mx-auto md:w-96 w-full">
        ...
        <router-link :to="{name: 'vehicles.create'}" class="btn btn-primary w-full">
            Add Vehicle
        </router-link>
        ...
        <div class="flex flex-col gap-2">
            <div v-for="vehicle in store.vehicles" :key="vehicle.id"
...
const deleteVehicle = (vehicle) => {
    swal({
        title: 'Are you sure?',
        text: 'This vehicle is gonna deleted!',
        type: 'warning',
        ...
        if(result.value)
        {
            ...
            swal({
                title: "Success",
                text: "Vehicle is deleted!",
                icon: "success"
            })
        }
    });
    
    // let deleteConfirmation = confirm("Are you sure want to delete this vehicle?");
